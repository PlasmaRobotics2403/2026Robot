...
public class RobotContainer {
    ...
    // Added mechanism subsystems copied from main project
    ...
    private void configureButtonBindings() {
        ...
        // Reset heading: keep current translation and zero the robot heading.
        controller
                .start()
        ...
        // Intake (run rollers + bring intake down). On release, intake stays down and rollers stop.
        controller.rightTrigger().whileTrue(new IntakeCommand(intake, 95.0, 95.0, 0.5));

        // Stow intake.
        controller.a().onTrue(Commands.runOnce(() -> intake.setPivotTargetDegrees(0.0), intake));

        // Turret follow command.
