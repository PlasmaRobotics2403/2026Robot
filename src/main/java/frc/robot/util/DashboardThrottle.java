 ...
 *
 * <p>Why: Pushing lots of NetworkTables/SmartDashboard keys at 50Hz can gradually bog down dashboards (Elastic,
 * Shuffleboard) during long driver-station sessions.
 *
 * <p>Usage:
 *
 * <pre>
...
public final class DashboardThrottle {
    ...
    /** Returns true if at least {@code periodSec} has elapsed since the last time this key was allowed. */
