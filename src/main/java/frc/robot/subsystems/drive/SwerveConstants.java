...
public class SwerveConstants {
  ...
  static {
    ...
    kCANBus = new CANBus(kCANbusName);
    ...
    kSteerCurrentLimit = 40.0;
    kDriveCurrentLimit = 120.0;
    ...
    kFLEncoderOffset = -Units.rotationsToRadians(TunerConstants.FrontLeft.EncoderOffset) + Math.PI;
    ...
    kBLEncoderOffset = -Units.rotationsToRadians(TunerConstants.BackLeft.EncoderOffset) + Math.PI;
  ...
  // SPARK encoder conversion constants (kept for compatibility with shared math)
